  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-4">
        <div className="grid h-14 w-14 place-items-center rounded-2xl border border-accent/30 bg-bg-2 font-display text-lg font-bold text-accent shadow-[0_0_40px_rgba(46,230,166,0.2)]">
          SK
        </div>
